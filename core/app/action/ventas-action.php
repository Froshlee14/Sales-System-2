...
if (isset($_GET["opt"]) && $_GET["opt"] == "add") {
    if($_POST["id_venta"]==0){
        ...
        Core::addToastr('info', 'Agrega productos a la venta');
        //Core::redir("./?view=ventas&opt=add&id_venta={$respuesta[1]}");
        Core::redir("./?view=detalle-venta&opt=add&id_venta={$respuesta[1]}");
    
    }
    else{
        Core::redir("./?view=detalle-venta&opt=add&id_venta={$_POST["id_venta"]}");
    }

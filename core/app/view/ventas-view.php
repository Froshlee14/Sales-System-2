        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a href="./?view=ventas&opt=Visualizar&id=<?php echo $row->id_venta;?>"> Ver detalles </a></td>
                </tr>
                <?php
                    }
                ?>
        ...
        <div class="card-body">
            <form action="./?action=ventas&opt=add" method="post" id="ventasForm" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <select id="producto_select" class="form-select" name="id_producto" onclick="tuFuncion()" required>
                        <?php
